...
public class myadapterdbnav extends FirebaseRecyclerAdapter<MyModel, myadapterdbnav.myviewholder> {
    ...
    Context ct;
    public myadapterdbnav(@NonNull FirebaseRecyclerOptions<MyModel> options, Context context) {
        super(options);
        ct = context;
    }
    ...
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull MyModel model) {
        ...
        //Glide.with(ct).load(model.getPostImageUrl()).into(holder.post);
        //holder.likeCounts.setText(model.getLikeCounts());
        //holder.post.setImageResource(Integer.parseInt(model.getPostImageUrl()));
        Glide.with(holder.post.getContext()).load(model.getPostImageUrl()).into(holder.post);
        //final MyModel temp = getItem(position);
    ...
    class myviewholder extends RecyclerView.ViewHolder{
        ...
        ImageView post;
        TextView title,shortDescription, category, dateandTime, likeCounts;
        Button readmore;
        ...
        public myviewholder(@NonNull View itemView) {
            ...
            dateandTime = itemView.findViewById(R.id.txt_dateandtime);
            likeCounts = itemView.findViewById(R.id.txt_LikeCount);
        }
